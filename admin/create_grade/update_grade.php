          ...
          <thead class="thead-dark">
            ...
            <th scope="col">รหัสนักศึกษา</th>
             ...
             <th></th>
              ...
              <tbody>
            <?php
            $sql = "SELECT tb_student.Std_Code,tb_student.Std_Fname,tb_grade.GPA,tb_student.class FROM tb_grade INNER JOIN tb_student ON tb_student.class =tb_student.class";
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              <td><?php echo $row['Std_Code']; ?></td>
                ...
                <td> 
                  <a href="../create_grade/update_grade.php?" class="btn btn-sm btn-warning text-white">
                    <i class=""></i>View
                  </a>
                </td>
              </tr>
