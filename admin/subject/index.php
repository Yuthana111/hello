...
<body>
  ...
  <li><a class="active" href=""><i class="fas fa-align-left"></i> จัดการข้อมูลรายวิชา</a></li>
    ...
    <div class="table-responsive">
          <div class="card">
            ...
            &nbsp;&nbsp;&nbsp;
                ...
                <input class="form-control w-50 p-3 ml-4" id="search" name="search" type="search" placeholder="Search" aria-label="Search">
                <button class="btn btn-primary ml-2" type="submit">Search</button>
              </form>
              <a href="../create_subject/create.php" class="btn btn-outline-success float-right"><i class="fas fa-plus-circle"></i> เพิ่มรายวิชา</a>
            </div> 
        ...
        <tbody>
          ...
          $sql = "SELECT * FROM tb_subject WHERE Sub_Name LIKE '%$search%'OR Sub_code LIKE '%$search%' 
          OR Teach_id LIKE '%$search%' ";
          // $sql = "SELECT tb_subject.Sub_id,tb_subject.Sub_code,tb_subject.Sub_Name,tb_subject.Sub_Credit,tb_subject.Teach_id ,tb_subject.CR 
          // FROM tb_subject 
          // INNER JOIN tb_register ON tb_subject.Teach_id = tb_register.Teach_code";
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            <tr>
              ...
              <td><?php echo $row['Sub_Credit']; ?></td>
              <td class="ml-5"><?php echo $row['CR']; ?></td>
              <td>
    ...
    <script>
      function deleteItem(id) {
        if (confirm('คุณต้องการลบข้อมูลใช่หรือไม่') == true) {
          window.location = `../create_subject/delete_subject.php?id=${id}`;
        }
      };
    </script>
